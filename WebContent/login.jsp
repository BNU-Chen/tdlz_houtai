...
function MM_callJS() { //v2.0
  ...
  if(myselectValue==1) {myform.action='http://localhost:8080/tdlz_dzjy02/j_spring_security_check';}
 else if(myselectValue==2){
 myform.action='http://localhost:8080/sell/j_spring_security_check';}
 else{
 myform.action='http://localhost:8080/tdlz_houtai/j_spring_security_check';} 
  myform.submit();
