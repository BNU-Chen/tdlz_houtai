/*
 * File: app/view/infoArticleZXDTTab.js
 *
...
Ext.define('MyApp.view.infoArticleZXDTTab', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.infoArticleZXDTTab',
                    ...
                    items: [
                                            ...
                                            items: [
                                                ...
                                                },
                                                {
                                                    ...
                                                    handler: function(button, event) {
                                                        var getDate = Ext.util.Format.date(Ext.getCmp('searchDatePub1').getValue(),'Y-m-d');
                                                        var getKeyword = Ext.getCmp('searchKeywordPub1').getValue();
                                                                        ...
                                                                        if (myform.isValid()) { // make sure the form contains valid data before submitting
                                                                            myform.submit({
                                                                                ...
                                                                                success: function(form, action) {
                                                                                    ...
                                                                                    //}
                                                                                    // );
                                                                                    var mystore = Ext.StoreMgr.get('ArticleDraftZXDTStore'); //获得store对象                                                   
                                                                                    mystore.load();
                                                                                    win.close();
                                                ...
                                                },
                                                {
                                                    xtype: 'button',
                                                    handler: function(button, event) {
                                                        var grid = Ext.getCmp('articlePubGrid1');
                                                        ...
                                                        if(record.length === 0){
                                                            ...
                                                            Ext.Ajax.request({
                                                                ...
                                                                success:function(response){
                                                                    ...
                                                                    var mystore = Ext.StoreMgr.get('ArticleRecZXDTStore');
                                                                    mystore.load();
                                                                    var mystore2 = Ext.StoreMgr.get('ArticlePubZXDTStore');
                                                                    mystore2.load();
                        ...
                        },
                        {
                            ...
                            items: [
                                {
                                    xtype: 'gridpanel',
                                    id: 'articleDraftGrid1',
                                    collapsible: false,
                                    title: '',
                                    forceFit: true,
                                    store: 'ArticleDraftZXDTStore',
                                    columns: [
                                        {
                                            xtype: 'rownumberer',
                                            width: 47,
                                    ...
                                    dockedItems: [
                                        {
                                            ...
                                            items: [
                                                ...
                                                },
                                                {
                                                    xtype: 'button',
                                                    handler: function(button, event) {
                                                        var getDate = Ext.util.Format.date(Ext.getCmp('searchDateDraft1').getValue(),'Y-m-d');
                                                        var getKeyword = Ext.getCmp('searchKeywordDraft1').getValue();
                                                        var mystore=Ext.StoreMgr.get('ArticleDraftZXDTStore'); //获得store对象
                                                        //在load事件中添加参数
                                                        mystore.load(
                                                        {params:{
                                                ...
                                                },
                                                {
                                                    xtype: 'button',
                                                    handler: function(button, event) {
                                                        var grid = Ext.getCmp('articleDraftGrid1');
                                                        ...
                                                        if(record.length === 0){
                                                            ...
                                                            Ext.Ajax.request({
                                                                ...
                                                                success:function(response){
                                                                    ...
                                                                    var mystore = Ext.StoreMgr.get('ArticleDraftZXDTStore');
                                                                    mystore.load();
                                                                    var mystore2 = Ext.StoreMgr.get('ArticlePubZXDTStore');
                                                                    mystore2.load();
                                    ...
                                    dockedItems: [
                                        {
                                            ...
                                            items: [
                                                ...
                                                },
                                                {
                                                    xtype: 'button',
                                                    handler: function(button, event) {
                                                        var getDate = Ext.util.Format.date(Ext.getCmp('searchDateRec1').getValue(),'Y-m-d');
                                                        var getKeyword = Ext.getCmp('searchKeywordRec1').getValue();
                                                        var mystore=Ext.StoreMgr.get('ArticleRecZXDTStore'); //获得store对象
                                                        //在load事件中添加参数
                                                        mystore.load(
                                                        {params:{
                                                            start:"0",
                                                ...
                                                },
                                                {
                                                    xtype: 'button',
                                                    handler: function(button, event) {
                                                        var grid = Ext.getCmp('articleRecGrid1');
    ...
    onArticlegridCellClick: function(tableview, td, cellIndex, record, tr, rowIndex, e, eOpts) {
        ...
        Ext.getCmp('channelId').setValue('最新动态');
