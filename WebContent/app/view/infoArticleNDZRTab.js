/*
 * File: app/view/infoArticleNDZRTab.js
 *
...
Ext.define('MyApp.view.infoArticleNDZRTab', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.infoArticleNDZRTab',
                    ...
                    items: [
                                            ...
                                            items: [
                                                ...
                                                },
                                                {
                                                    ...
                                                    handler: function(button, event) {
                                                        var getDate = Ext.util.Format.date(Ext.getCmp('searchDatePub4').getValue(),'Y-m-d');
                                                        var getKeyword = Ext.getCmp('searchKeywordPub4').getValue();
                                                ...
                                                },
                                                {
                                                    xtype: 'button',
                                                    handler: function(button, event) {
                                                        Ext.widget("infoAritcleNDZRNewWindow").show();
                                                ...
                                                },
                                                {
                                                    xtype: 'button',
                                                    handler: function(button, event) {
                                                        var grid = Ext.getCmp('articlePubGrid4');
                                                        ...
                                                        if(record.length === 0){
                                                            ...
                                                            Ext.Ajax.request({
                                                                ...
                                                                success:function(response){
                                                                    Ext.Msg.alert('success','信息放入到回收站');
                                                                    var mystore = Ext.StoreMgr.get('ArticleRecNDZRStore');
                                                                    mystore.load();
                                                                    var mystore2 = Ext.StoreMgr.get('ArticlePubNDZRStore');
                                                                    mystore2.load();
                                                ...
                                                },
                                                {
                                                    ...
                                                    handler: function(button, event) {
                                                        ...
                                                        var m_store_ticket=Ext.StoreMgr.get('ArticlePubNDZRStore'); //获得store对象 
                                                        ...
                                                        {title: '农地转入信息推送',
                                                            ...
                                                            items: [
                                                            {
                                                                ...
                                                                },
                                                                {
                                                                    ...
                                                                    },
                                                                    {
                                                                        xtype: 'button',
                                                                        handler: function(button, event) {
                                                                            var mystore=Ext.StoreMgr.get('gxuserStoreNDZR'); //获得store对象
                                                                            var myvalue=Ext.getCmp('searchUsers_ndzr').getValue();
                                                                            //在load事件中添加参数
                                                                            mystore.load(
                                                                            {params:{
                                                                                start:"0",
                                                            ...
                                                            listeners: {
                                                                cellclick: {
                                                                    fn: me.onNDZR_pushgridCellClick,
                                                                    scope: me
                                                                }
                                                            }
                                                        },
                                                        {
                                                            ...
                                                            },
                                                            {
                                                                ...
                                                                handler: function(button, event) {
                                                                    ...
                                                                    var my_grid=Ext.getCmp('NDZR_pushgrid');
                                                                    var my_record =my_grid.getSelectionModel().getSelection();

                                                                    //获取用户选中的记录id
                                                                    //var my_lbl=Ext.getCmp("userChoice_lblndzr");
                                                                    // var my_ids=my_lbl.text;

                                                                    //用来获得“推送给全部用户”checkbox是否勾选,以及邮件和短信checkbox是否勾选
                                                                    var mycheckall=Ext.getCmp('pushall_cboxndzr').getValue();
                                                                    var mycheckMail=Ext.getCmp('sendMail_cboxndzr').getValue();
                                                                    var mycheckSMS=Ext.getCmp('sendSMS_cboxndzr').getValue();
                                                    ...
                                                    {  
                                                        ...
                                                        // Ext.Msg.alert('mygrid',mygrid);
                                                        var myidslbl=Ext.getCmp('userChoice_lblndzr');  
                                                        myidslbl.text=ids;
                                                        myidslbl.hidden=true;
                                                        win.show();

                                                        //弹出的窗口自动加载用户数据
                                                        var mstore=Ext.StoreMgr.get('gxuserStoreNDZR'); //获得store对象                   
                                                        //在load事件中添加参数
                                                        mstore.load(
                                                        {params:{
                                                            start:'0',
                        ...
                        },
                        {
                            ...
                            items: [
                                {
                                    xtype: 'gridpanel',
                                    id: 'articleDraftGrid4',
                                    collapsible: false,
                                    title: '',
                                    forceFit: true,
                                    store: 'ArticleDraftNDZRStore',
                                    columns: [
                                        {
                                            xtype: 'rownumberer',
                                            width: 47,
                                    ...
                                    dockedItems: [
                                        {
                                            ...
                                            items: [
                                                ...
                                                },
                                                {
                                                    xtype: 'button',
                                                    handler: function(button, event) {
                                                        var getDate = Ext.util.Format.date(Ext.getCmp('searchDateDraft4').getValue(),'Y-m-d');
                                                        var getKeyword = Ext.getCmp('searchKeywordDraft4').getValue();
                                                        var mystore=Ext.StoreMgr.get('ArticleDraftNDZRStore'); //获得store对象
                                                        //在load事件中添加参数
                                                        mystore.load(
                                                        {params:{
                                                            start:"0",
                                                ...
                                                },
                                                {
                                                    xtype: 'button',
                                                    handler: function(button, event) {
                                                        var grid = Ext.getCmp('articleDraftGrid4');
                                                        ...
                                                        if(record.length === 0){
                                                            ...
                                                            Ext.Ajax.request({
                                                                ...
                                                                success:function(response){
                                                                    ...
                                                                    var mystore = Ext.StoreMgr.get('ArticleDraftNDZRStore');
                                                                    mystore.load();
                                                                    var mystore2 = Ext.StoreMgr.get('ArticlePubNDZRStore');
                                                                    mystore2.load();
                                    ...
                                    dockedItems: [
                                        {
                                            ...
                                            items: [
                                                ...
                                                },
                                                {
                                                    xtype: 'button',
                                                    handler: function(button, event) {
                                                        var getDate = Ext.util.Format.date(Ext.getCmp('searchDateRec4').getValue(),'Y-m-d');
                                                        var getKeyword = Ext.getCmp('searchKeywordRec18').getValue();
                                                        var mystore=Ext.StoreMgr.get('ArticleRecNDZRStore'); //获得store对象
                                                        //在load事件中添加参数
                                                        mystore.load(
                                                        {params:{
                                                            start:"0",
                                                ...
                                                },
                                                {
                                                    xtype: 'button',
                                                    handler: function(button, event) {
                                                        var grid = Ext.getCmp('articleRecGrid4');
