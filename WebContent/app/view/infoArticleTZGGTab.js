/*
 * File: app/view/infoArticleTZGGTab.js
 *
...
Ext.define('MyApp.view.infoArticleTZGGTab', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.infoArticleTZGGTab',
                    ...
                    items: [
                                            ...
                                            items: [
                                                ...
                                                },
                                                {
                                                    ...
                                                    handler: function(button, event) {
                                                        var getDate = Ext.util.Format.date(Ext.getCmp('searchDatePub2').getValue(),'Y-m-d');
                                                        var getKeyword = Ext.getCmp('searchKeywordPub2').getValue();
                                                        var mystore=Ext.StoreMgr.get('ArticlePubTZGGStore'); //获得store对象
                                                        //在load事件中添加参数
                                                        mystore.load(
                                                        {params:{
                                                            start:"0",
                                                                        ...
                                                                        if (myform.isValid()) { // make sure the form contains valid data before submitting
                                                                            myform.submit({
                                                                                ...
                                                                                success: function(form, action) {
                                                                                    ...
                                                                                    //}
                                                                                    // );
                                                                                    var mystore = Ext.StoreMgr.get('ArticleDraftTZGGStore'); //获得store对象                                                   
                                                                                    mystore.load();
                                                                                    win.close();
                                                ...
                                                },
                                                {
                                                    xtype: 'button',
                                                    handler: function(button, event) {
                                                        var grid = Ext.getCmp('articlePubGrid2');
                                                        ...
                                                        if(record.length === 0){
                                                            ...
                                                            Ext.Ajax.request({
                                                                ...
                                                                success:function(response){
                                                                    ...
                                                                    var mystore = Ext.StoreMgr.get('ArticleRecTZGGStore');
                                                                    mystore.load();
                                                                    var mystore2 = Ext.StoreMgr.get('ArticlePubTZGGStore');
                                                                    mystore2.load();
                        ...
                        },
                        {
                            ...
                            items: [
                                {
                                    xtype: 'gridpanel',
                                    id: 'articleDraftGrid2',
                                    collapsible: false,
                                    title: '',
                                    forceFit: true,
                                    store: 'ArticleDraftTZGGStore',
                                    columns: [
                                        {
                                            xtype: 'rownumberer',
                                            width: 47,
                                    ...
                                    dockedItems: [
                                        {
                                            ...
                                            items: [
                                                ...
                                                },
                                                {
                                                    xtype: 'button',
                                                    handler: function(button, event) {
                                                        var getDate = Ext.util.Format.date(Ext.getCmp('searchDateDraft2').getValue(),'Y-m-d');
                                                        var getKeyword = Ext.getCmp('searchKeywordDraft2').getValue();
                                                        var mystore=Ext.StoreMgr.get('ArticleDraftTZGGStore'); //获得store对象
                                                        //在load事件中添加参数
                                                        mystore.load(
                                                        {params:{
                                                ...
                                                },
                                                {
                                                    xtype: 'button',
                                                    handler: function(button, event) {
                                                        var grid = Ext.getCmp('articleDraftGrid2');
                                                        ...
                                                        if(record.length === 0){
                                                            ...
                                                            Ext.Ajax.request({
                                                                ...
                                                                success:function(response){
                                                                    ...
                                                                    var mystore = Ext.StoreMgr.get('ArticleDraftTZGGStore');
                                                                    mystore.load();
                                                                    var mystore2 = Ext.StoreMgr.get('ArticlePubTZGGStore');
                                                                    mystore2.load();
                                    ...
                                    dockedItems: [
                                        {
                                            ...
                                            items: [
                                                ...
                                                },
                                                {
                                                    xtype: 'button',
                                                    handler: function(button, event) {
                                                        var getDate = Ext.util.Format.date(Ext.getCmp('searchDateRec2').getValue(),'Y-m-d');
                                                        var getKeyword = Ext.getCmp('searchKeywordRec2').getValue();
                                                        var mystore=Ext.StoreMgr.get('ArticleRecTZGGStore'); //获得store对象
                                                        //在load事件中添加参数
                                                        mystore.load(
                                                        {params:{
                                                            start:"0",
                                                ...
                                                },
                                                {
                                                    xtype: 'button',
                                                    handler: function(button, event) {
                                                        var grid = Ext.getCmp('articleRecGrid2');
    ...
    onArticlegridCellClick: function(tableview, td, cellIndex, record, tr, rowIndex, e, eOpts) {
        ...
        Ext.getCmp('channelId').setValue('通知公告');
