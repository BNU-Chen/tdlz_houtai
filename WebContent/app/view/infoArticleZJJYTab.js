/*
 * File: app/view/infoArticleZJJYTab.js
 *
...
Ext.define('MyApp.view.infoArticleZJJYTab', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.infoArticleZJJYTab',
                    ...
                    items: [
                                            ...
                                            items: [
                                                ...
                                                },
                                                {
                                                    ...
                                                    handler: function(button, event) {
                                                        var getDate = Ext.util.Format.date(Ext.getCmp('searchDatePub5').getValue(),'Y-m-d');
                                                        var getKeyword = Ext.getCmp('searchKeywordPub5').getValue();
                                                        var mystore=Ext.StoreMgr.get('ArticlePubZJJYStore'); //获得store对象
                                                        //在load事件中添加参数
                                                        mystore.load(
                                                        {params:{
                                                            start:"0",
                                                                        ...
                                                                        if (myform.isValid()) { // make sure the form contains valid data before submitting
                                                                            myform.submit({
                                                                                ...
                                                                                success: function(form, action) {
                                                                                    ...
                                                                                    //}
                                                                                    // );
                                                                                    var mystore = Ext.StoreMgr.get('ArticleDraftZJJYStore'); //获得store对象                                                   
                                                                                    mystore.load();
                                                                                    win.close();
                                                ...
                                                },
                                                {
                                                    xtype: 'button',
                                                    handler: function(button, event) {
                                                        var grid = Ext.getCmp('articlePubGrid5');
                                                        ...
                                                        if(record.length === 0){
                                                            ...
                                                            Ext.Ajax.request({
                                                                ...
                                                                success:function(response){
                                                                    ...
                                                                    var mystore = Ext.StoreMgr.get('ArticleRecZJJYStore');
                                                                    mystore.load();
                                                                    var mystore2 = Ext.StoreMgr.get('ArticlePubZJJYStore');
                                                                    mystore2.load();
                        ...
                        },
                        {
                            ...
                            items: [
                                {
                                    xtype: 'gridpanel',
                                    id: 'articleDraftGrid5',
                                    collapsible: false,
                                    title: '',
                                    forceFit: true,
                                    store: 'ArticleDraftZJJYStore',
                                    columns: [
                                        {
                                            xtype: 'rownumberer',
                                            width: 47,
                                    ...
                                    dockedItems: [
                                        {
                                            ...
                                            items: [
                                                ...
                                                },
                                                {
                                                    xtype: 'button',
                                                    handler: function(button, event) {
                                                        var getDate = Ext.util.Format.date(Ext.getCmp('searchDateDraft5').getValue(),'Y-m-d');
                                                        var getKeyword = Ext.getCmp('searchKeywordDraft5').getValue();
                                                        var mystore=Ext.StoreMgr.get('ArticleDraftZJJYStore'); //获得store对象
                                                        //在load事件中添加参数
                                                        mystore.load(
                                                        {params:{
                                                ...
                                                },
                                                {
                                                    xtype: 'button',
                                                    handler: function(button, event) {
                                                        var grid = Ext.getCmp('articleDraftGrid5');
                                                        ...
                                                        if(record.length === 0){
                                                            ...
                                                            Ext.Ajax.request({
                                                                ...
                                                                success:function(response){
                                                                    ...
                                                                    var mystore = Ext.StoreMgr.get('ArticleDraftZJJYStore');
                                                                    mystore.load();
                                                                    var mystore2 = Ext.StoreMgr.get('ArticlePubZJJYStore');
                                                                    mystore2.load();
                                    ...
                                    dockedItems: [
                                        {
                                            ...
                                            items: [
                                                ...
                                                },
                                                {
                                                    xtype: 'button',
                                                    handler: function(button, event) {
                                                        var getDate = Ext.util.Format.date(Ext.getCmp('searchDateRec5').getValue(),'Y-m-d');
                                                        var getKeyword = Ext.getCmp('searchKeywordRec5').getValue();
                                                        var mystore=Ext.StoreMgr.get('ArticleRecZJJYStore'); //获得store对象
                                                        //在load事件中添加参数
                                                        mystore.load(
                                                        {params:{
                                                            start:"0",
                                                ...
                                                },
                                                {
                                                    xtype: 'button',
                                                    handler: function(button, event) {
                                                        var grid = Ext.getCmp('articleRecGrid5');
    ...
    onArticlegridCellClick: function(tableview, td, cellIndex, record, tr, rowIndex, e, eOpts) {
        ...
        Ext.getCmp('channelId').setValue('最近交易');
